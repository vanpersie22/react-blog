        ...
        <div className='p-3 md:mx-auto'>
            ...
            w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiOutlineUserGroup className='bg-green-500 text-white 
            ...
            w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiAnnotation className='bg-red-500 text-white 
                        rounded-full text-5xl p-3 shadow-lg' />
            ...
            w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiDocumentText className='bg-indigo-500 text-white 
                        rounded-full text-5xl p-3 shadow-lg' />
            ...
            <div className=" flex flex-wrap gap-4 py-3 mx-auto justify-center">
                <div className="flex flex-col w-full md:w-auto shadow-md p-2 mt-4
                    ...
                    <Table hoverable>
                       ...
                       {posts && posts.map((post) => (
                            <Table.Body key={post._id} className='divide-y'>
                                <Table.Row className='bg-white dark:border-gray-700 dark:bg-gray-800'>
                                    <Table.Cell>
                                        <img src={post.image} alt="" className='w-14 h-10 rounded-md' />
                                    </Table.Cell>
